...
{
    udph->source = htons(55535 + rand_cmwc() % 65535);
...
void *flood(void *par1)
{
		...
		for(int i = 0; i <= packet_size; i++){
                ...
                sport[i] = htons(randnum(64932,64932));
		...
		while(1){
				...
				packet_lenght = randnum(120, packet_size);
